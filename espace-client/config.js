...
// Adresse qui donne accès à la vue « tous les projets » au lieu du suivi d'un
// seul client. Elle n'a rien de secret : ce qui autorise réellement la lecture
// de tous les projets, c'est la policy RLS côté Supabase (SETUP.md, étape 3 bis).
export const ADMIN_EMAIL = "raph.proudhon@gmail.com";
